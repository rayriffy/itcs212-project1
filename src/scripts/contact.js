  ...
  document
    ...
    .addEventListener("click", () => {
      ...
      if (entrites.filter(([_key, val]) => val.trim() === "").length > 0) {
        document.querySelector(".submit > .error").innerText =
        ...
        document.querySelector("div.content > div.flex > h1").innerText =
          "Sent";
        ...
        document.querySelector("div.content > p").innerText =
          "Message has been sent to recipiant. We will reply back to you in a few business days.";
      }
    });
});
